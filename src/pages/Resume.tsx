  ...
  const experience = [
    {
      ...
      description:
        "Leading development of ML models for production systems. Improved model accuracy by 35% and reduced inference time by 50%.",
    },
    {
    ...
    <main className="min-h-screen pt-24 pb-16 px-6">
      <div className="container mx-auto max-w-5xl">
        ...
        <div className="text-center mb-16 animate-fade-in">
          ...
          <a href="/arnob_barua_CV.pdf" download>
            <Button
              size="lg"
